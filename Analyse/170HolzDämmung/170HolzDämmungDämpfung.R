...
library(openxlsx)
tabelle1 <- read.xlsx("./Analyse/170HolzDämmung/170HolzDämmung_neu.xlsx")
...
write_xlsx(kombinierte_tabelle, "./Analyse/170HolzDämmung/Kombiniert.xlsx")


library(ggplot2)

# 3. Excel-Datei einlesen
daten <- read_excel("./Analyse/170HolzDämmung/Kombiniert.xlsx")
