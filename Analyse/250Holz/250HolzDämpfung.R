...
tabelle1 <- read.xlsx("C:\\Users\\veren\\OneDrive\\Dokumente\\Holztechnikum\\Diplomarbeit\\Analyse\\250Holz\\250Holz_neu.xlsx")
...
write_xlsx(kombinierte_tabelle, "C:/Users/veren/OneDrive/Dokumente/Holztechnikum/Diplomarbeit/Analyse/250Holz/Kombiniert.xlsx")


library(ggplot2)

# 3. Excel-Datei einlesen
daten <- read_excel("C:/Users/veren/OneDrive/Dokumente/Holztechnikum/Diplomarbeit/Analyse/250Holz/Kombiniert.xlsx")
...
grafik <- ggplot(daten, aes(x = Frequency, y = `Differenz`)) + 
  ...
  labs(
    title = "Dämpfung 25 cm Holz",  # Titel der Grafik
