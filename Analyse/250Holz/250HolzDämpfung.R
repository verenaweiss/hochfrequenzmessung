...
tabelle1 <- read.xlsx("./Analyse/250Holz/250Holz_neu.xlsx")
...
write_xlsx(kombinierte_tabelle, "./Analyse/250Holz/Kombiniert.xlsx")


library(ggplot2)

# 3. Excel-Datei einlesen
daten <- read_excel("./Analyse/250Holz/Kombiniert.xlsx")
