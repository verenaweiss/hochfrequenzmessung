...
tabelle1 <- read_excel("./Analyse/Messungen/250Holz_20240724_01.xls")
tabelle2 <- read_excel("./Analyse/Messungen/250Holz_20240724_02.xls")
tabelle3 <- read_excel("./Analyse/Messungen/250Holz_20240724_03.xls")
...
write_xlsx(werte, "./Analyse/250Holz/250Holz_neu.xlsx")
