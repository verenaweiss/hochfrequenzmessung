...
library(openxlsx)
tabelle1 <- read.xlsx("C:\\Users\\veren\\OneDrive\\Dokumente\\Holztechnikum\\Diplomarbeit\\Analyse\\170Holz\\170Holz_neu.xlsx")
...
write_xlsx(kombinierte_tabelle, "C:/Users/veren/OneDrive/Dokumente/Holztechnikum/Diplomarbeit/Analyse/170Holz/Kombiniert.xlsx")


library(ggplot2)

# 3. Excel-Datei einlesen
daten <- read_excel("C:/Users/veren/OneDrive/Dokumente/Holztechnikum/Diplomarbeit/Analyse/170Holz/Kombiniert.xlsx")
...
grafik <- ggplot(daten, aes(x = Frequency, y = `Dämpfung [dB]`)) + 
  ...
  labs(
    title = "Dämpfung 17 cm Holz",  # Titel der Grafik
