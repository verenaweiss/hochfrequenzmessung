...
library(openxlsx)
tabelle1 <- read.xlsx("./Analyse/170Holz/170Holz_neu.xlsx")
...
write_xlsx(kombinierte_tabelle, "./Analyse/170Holz/Kombiniert.xlsx")


library(ggplot2)

# 3. Excel-Datei einlesen
daten <- read_excel("./Analyse/170Holz/Kombiniert.xlsx")
