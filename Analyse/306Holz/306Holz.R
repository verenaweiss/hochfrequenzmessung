...
tabelle1 <- read_excel("./Analyse/Messungen/306Holz_20240724_01.xls")
tabelle2 <- read_excel("./Analyse/Messungen/306Holz_20240724_02.xls")
tabelle3 <- read_excel("./Analyse/Messungen/306Holz_20240724_03.xls")
...
write_xlsx(werte, "./Analyse/306Holz/306Holz_neu.xlsx")
