...
tabelle1 <- read.xlsx("./Analyse/306Holz/306Holz_neu.xlsx")
...
write_xlsx(kombinierte_tabelle, "./Analyse/306Holz/Kombiniert.xlsx")


library(ggplot2)

# 3. Excel-Datei einlesen
daten <- read_excel("./Analyse/306Holz/Kombiniert.xlsx")
