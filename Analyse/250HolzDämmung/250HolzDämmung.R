...
tabelle1 <- read_excel("C:\\Users\\veren\\OneDrive\\Dokumente\\Holztechnikum\\Diplomarbeit\\Analyse\\Messungen\\250Holz_80Dämmung_20240724_01.xls")
tabelle2 <- read_excel("C:\\Users\\veren\\OneDrive\\Dokumente\\Holztechnikum\\Diplomarbeit\\Analyse\\Messungen\\250Holz_80Dämmung_20240724_02.xls")
tabelle3 <- read_excel("C:\\Users\\veren\\OneDrive\\Dokumente\\Holztechnikum\\Diplomarbeit\\Analyse\\Messungen\\250Holz_80Dämmung_20240724_03.xls")
...
ggplot(werte, aes(x = Frequency, y = Mittelwert)) +  # x = Frequency, y = Mittelwert
  ...
  labs(
    title = "Mittelwerte 25 cm Holz100 8 cm Dämmung",  # Titel des Diagramms
    x = "Frequenz (Hz)",  # x-Achse: Frequency
    y = "Mittelwert (Generator Level/V)"  # y-Achse: Mittelwert
  ) +
  theme_minimal()  # Minimalistisches Design

write_xlsx(werte, "C:/Users/veren/OneDrive/Dokumente/Holztechnikum/Diplomarbeit/Analyse/250HolzDämmung/250HolzDämmung_neu.xlsx")
