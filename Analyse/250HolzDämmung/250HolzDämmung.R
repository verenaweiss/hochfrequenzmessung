...
tabelle1 <- read_excel("./Analyse/Messungen/250Holz_80Dämmung_20240724_01.xls")
tabelle2 <- read_excel("./Analyse/Messungen/250Holz_80Dämmung_20240724_02.xls")
tabelle3 <- read_excel("./Analyse/Messungen/250Holz_80Dämmung_20240724_03.xls")
...
write_xlsx(werte, "./Analyse/250HolzDämmung/250HolzDämmung_neu.xlsx")
